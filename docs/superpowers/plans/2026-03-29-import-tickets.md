...
**Goal:** Add a platform-agnostic ticket import system that pulls issues from external platforms (starting with GitHub Issues) into Octob's kanban board, with on-demand remote status updates.
...
Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npx tsc --noEmit src/main/services/ticket-providers/ticket-provider-types.ts 2>&1 | head -20`
...
Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npm run build 2>&1 | tail -5`
...
Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npm run build 2>&1 | tail -10`
...
Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npx graphql-codegen 2>&1 | tail -5`
...
Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npm run build 2>&1 | tail -20`

The build should succeed with no errors. Warnings are acceptable.

- [ ] **Step 2: Check TypeScript strict mode**

Run: `cd /Users/mor/.octob-worktrees/octob-electron/octob-electron--import-tickets && npx tsc --noEmit 2>&1 | tail -20`
